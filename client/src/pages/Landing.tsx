    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden selection:bg-primary/20">
      ...
      <main className="relative z-10 container mx-auto px-6 pt-20 pb-32">
        ...
        >
          <motion.div
            variants={item}
            className="mb-6 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-secondary/30 border border-white/5 text-sm font-medium text-primary-foreground/80"
          >
          ...
          <motion.h1
            variants={item}
            className="text-5xl md:text-7xl font-display font-bold leading-[1.1] mb-8 bg-gradient-to-br from-white via-white/90 to-white/50 bg-clip-text text-transparent"
          >
            Your personal engineering <br className="hidden md:block" />{" "}
            knowledge base.
          </motion.h1>
          ...
          >
            Stop losing track of your side projects. Centralize your environment
            variables, test users, bug reports, and improvement backlogs in one
            secure place.
          </motion.p>
          ...
          >
            <Button
              asChild
              size="lg"
              className="h-14 px-8 text-lg rounded-full shadow-[0_0_40px_-10px_rgba(59,130,246,0.5)]"
            >
              <a href="/api/login">
